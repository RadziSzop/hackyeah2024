        ...
        <RadioGroup className="flex flex-col gap-6" defaultValue={"Umowa"}>
          <div className="flex items-center space-x-3">
            <RadioGroupItem
              ...
              className="w-5 h-5"
              onClick={() => setValue("type_of_transaction", "umowa sprzedaży")}
            />
            <Label
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <Label htmlFor="subject_of_taxation_darowizna" className="text-lg">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Label
              ...
              className="text-lg"
            >
              Ustanowienie hipoteki na zabezpieczenie wierzytelności o wysokości
              nieustalonej
            </Label>
          </div>
          <div className="flex items-center space-x-3">
        ...
        <>
          <div className="mb-6 flex flex-col gap-4">
            <Label className="mb-2 block">
              ...
              wysokości nieustalonej - podstawa opodatkowania określona zgodnie
              z art. 6 ustawy zł
            </Label>
            <Input
          ...
          <div className="mb-6 flex flex-col gap-4">
            <Label className="mb-2 block">
              ...
              wysokości nieustalonej - stawka podatku określona zgodnie z art. 7
              ustawy
            </Label>
            <Input
        ...
        <>
          <div className="mb-6 flex flex-col gap-4">
            <Label className="mb-2 block">
              ...
              obdarowanego długów i ciężarów lub zobowiązań darczyńcy - podstawa
              opodatkowania określona zgodnie z art. 6 ustawy zł
            </Label>
            <Input
        ...
        <>
          ...
          <div className="mb-6 flex flex-col gap-4">
            <Label className="mb-2 block">
              ...
              na podstawie art. 9 pkt 10 lit.b ustawy - stawka podatku określona
